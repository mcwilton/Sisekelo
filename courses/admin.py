...
from .models import Learnership, Nfq, Accredited_Program, Skills_Program, Specialized_Course

#admin.site.register(Nfq)

@admin.register(Learnership)
class LearnershipAdmin(admin.ModelAdmin):
    list_display = ('title', 'certificate_type', 'mode_of_delivery', 'nfq_level', 'duration', 'status', 'image')
