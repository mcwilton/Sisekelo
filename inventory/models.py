...
class Device(models.Model):
    ...
    lendee = models.ForeignKey(User, null=True, blank=True, unique=False, on_delete=models.CASCADE, related_name="lendee")
    lender = models.ForeignKey(User, null=True, blank=True, unique=False, on_delete=models.CASCADE, related_name="lender")
